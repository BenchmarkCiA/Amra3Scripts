...
export default function SocialIcons({ links, size = "md", onDark = false }: Props) {
  const dim = size === "sm" ? 36 : 44
  const iconDim = size === "sm" ? 15 : 18
      ...
      {socials.map(({ key, label, href, Icon }) => (
        <a
          ...
          style={{
            ...
            height: dim,
            borderRadius: "50%",
            background: onDark ? "rgba(255,255,255,0.15)" : "#14161a",
        ...
        >
          <div style={{ width: iconDim, height: iconDim }}>
            <Icon />
          </div>
        </a>
      ))}
