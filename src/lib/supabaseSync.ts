...
function mapChallenge(row: any): Challenge {
  return {
    ...
    memorySymbols: row.memory_symbols ?? undefined,
    drawPrompts: row.draw_prompts ?? undefined,
    comparisonIcons: row.comparison_icons ?? undefined,
    missingIcons: row.missing_icons ?? undefined,
...
function challengeRow(challenge: Challenge) {
  return {
    ...
    memory_symbols: challenge.memorySymbols ?? null,
    draw_prompts: challenge.drawPrompts ?? null,
    comparison_icons: challenge.comparisonIcons ?? null,
    missing_icons: challenge.missingIcons ?? null,
